...
namespace Client.ViewModels
{
    public class ChatViewModel : BindableBase
    {
        ...
        public ChatViewModel(IMessageService messageService, IConnectionService connectionService, IDialogService dialogService)
        {
        ...
        {
            if (Chats.Any(x => x.Name != e.SenderName))
            {
                ...
                Chats.Add(new Chat(users, e.SenderName));
            }

            if (SelectedChat.Name != Chats.First(x => x.Name == e.SenderName).Name)
            {
                return;
            }
        ...
        private void CreateDialogWithUser()
        {
            ...
            _dialogService.ShowDialog("CreateDialog", dialogParameters, r =>
            {
                ...
                Chats.Add(new Chat(users, selectedUser.Name));
            });
        }
        ...
        private void OnUserConnectOrDisconnect(object sender, GetUserEventArgs e)
        {
            App.Current.Dispatcher.Invoke(delegate
            {
                if (e.IsConnect)
                {
                    ...
                    Chats[0].Users.Add(new User(e.Login));
                }
                else
                {

                    Chats[0].Users.Remove(Users.First(x => x.Name == e.Login));
        ...
        private void OnGetUsers(object sender, GetUsersEventArgs e)
        {
            App.Current.Dispatcher.Invoke(delegate
            {
                ...
                Chats.Add(new Chat(Users.ToList(), "Главный чат"));
        ...
        private void ExecuteCommand()
        {
            ...
            //_messageService.SendMessage(message.Name, message.Text);
